...
export class Dispatcher {
	...
	_dispatch: (action: Action) => Promise<StoresMap>;
	...
	constructor(stores: StoresMap, subscriptionHandler: ?SubscriptionHandler) {
		...
		this._dispatch = createDispatchFunction({
			initalStores: stores,
			onUpdatedStores: this._onUpdatedStores.bind(this),
			onError: this._onDispatchError.bind(this)
		});
	}
	...
	dispatch(action: Action): Promise<StatesObject> {
		...
		const updatedStoresPromise = this._dispatch(action);
